...
--   end
   ...
   local trainData = torch.load('/home/jie/Documents/lua_workspace/torch-autograd/source/mnist/train.t7')
   local testData = torch.load('/home/jie/Documents/lua_workspace/torch-autograd/source/mnist/test.t7')
